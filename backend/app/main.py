...
from app.api.routes.mobs import router as mobs_router
...
from app.api.routes.weapons import router as weapons_router
...
app.include_router(mobs_router, prefix="/api/v1")
