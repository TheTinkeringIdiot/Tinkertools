...
describe('ActionRequirements', () => {
  const mockActions: Action[] = [
    ...
    },
    {
      ...
      action: 8, // Attack
      item_id: 123,
      criteria: [{ id: 2, value1: 54, value2: 150, operator: 2 }],
    },
    {
      id: 3,
      action: 1, // Get
  ...
  describe('props validation', () => {
    ...
    it('should handle null character stats', () => {
      ...
      const statusTags = tags.filter(
        (tag) => tag.props('severity') === 'secondary' && tag.props('value') === 'Unknown'
      );
      ...
      const baseActions: Action[] = [
        {
          ...
          action: 6,
          item_id: 123,
          criteria: [{ id: 1, value1: 112, value2: 300, operator: 2 }],
        },
      ];
      ...
      const interpolatedActions: Action[] = [
        {
          ...
          action: 6,
          item_id: 123,
          criteria: [{ id: 1, value1: 112, value2: 340, operator: 2 }],
        },
      ];
        ...
        const newActions: Action[] = [
          {
            ...
            action: 6,
            item_id: 123,
            criteria: [{ id: 1, value1: 112, value2: 300 + i * 10, operator: 2 }],
          },
        ];
