...
describe('CriteriaDisplay', () => {
  ...
  describe('complex criteria', () => {
      ...
      mockUseCriteriaDisplay.groupedRequirements.value = [
        {
          stat: 112,
          statName: 'Pistol',
          criteria: [mockDisplayCriteria[0], {
    ...
    it('should handle nested logical expressions', () => {
      mockUseCriteriaDisplay.formattedText.value = '((Pistol ≥ 301 AND Pistol ≤ 499) AND Level ≥ 151)'
  ...
  describe('edge cases', () => {
    it('should handle malformed criteria gracefully', () => {
      const malformedCriteria: Criterion[] = [
        { id: 1, value1: 999, value2: 999, operator: 999 }
      ]
