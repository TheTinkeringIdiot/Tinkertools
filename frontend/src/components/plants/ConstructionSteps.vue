...
<template>
  <div class="construction-steps space-y-6">
    ...
    <div v-else-if="isSuccessful" class="space-y-6">
      ...
      >
        <div
          class="bg-surface-100 dark:bg-surface-800 px-6 py-4 border-b border-surface-200 dark:border-surface-700"
        >
        ...
        <div class="p-6">
          <div class="space-y-3">
            ...
            >
              <div
                class="flex-shrink-0 w-8 h-8 bg-orange-100 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 rounded-full flex items-center justify-center text-sm font-medium"
              >
                {{ index + 1 }}
              </div>
              <div class="flex-1">
                ...
                <div
                  v-if="step.description !== step.step"
      ...
      >
        ...
        <div class="p-6">
          <div class="space-y-3">
            ...
            >
              <div
                class="flex-shrink-0 w-8 h-8 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full flex items-center justify-center text-sm font-medium"
              >
                {{ index + 1 }}
              </div>
              <div class="flex-1">
      ...
      >
        <h4
          class="font-semibold text-surface-900 dark:text-surface-50 mb-4 flex items-center gap-2"
        >
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <div class="font-mono text-sm font-medium text-surface-900 dark:text-surface-50">
              {{ value }}
            </div>
          </div>
        </div>
    ...
    <div
      v-else
      class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-6"
    >
      <div class="flex items-start gap-3">
        ...
        <div>
          <h4 class="font-medium text-yellow-900 dark:text-yellow-100 mb-2">
            No Construction Plan Available
          </h4>
          <p class="text-sm text-yellow-700 dark:text-yellow-300">
            Unable to generate a construction plan for this configuration. Check your skill levels
            and implant selections.
          </p>
        </div>
      </div>
    </div>
