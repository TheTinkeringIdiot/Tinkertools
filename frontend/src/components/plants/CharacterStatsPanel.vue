...
<template>
  <div class="character-stats-panel p-3">
    ...
    <!-- Base Stats -->
    <div class="space-y-2">
      <h4 class="text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Base Stats</h4>

      <div v-for="stat in baseStats" :key="stat.id" class="flex items-center justify-between">
    ...
    <div class="mt-4 space-y-2">
      <h4 class="text-sm font-medium text-surface-700 dark:text-surface-300 mb-2">Nano Skills</h4>

      <div v-for="skill in nanoSkills" :key="skill.id" class="flex items-center justify-between">
...
const statPresets = {
  ...
  mid: {
    ...
    psychic: 400,
    matter_creation: 300,
    matter_metamorphosis: 300,
    psychological_modifications: 300,
    biological_metamorphosis: 300,
    sensory_improvement: 300,
    time_and_space: 300,
    treatment: 800,
  },
  high: {
    ...
    psychic: 800,
    matter_creation: 700,
    matter_metamorphosis: 700,
    psychological_modifications: 700,
    biological_metamorphosis: 700,
    sensory_improvement: 700,
    time_and_space: 700,
    treatment: 1500,
  },
  twink: {
