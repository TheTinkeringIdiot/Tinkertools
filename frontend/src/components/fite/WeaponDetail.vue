  ...
  >
    <div v-if="weapon" class="space-y-6">
      ...
      >
        ...
        <WeaponRequirements :weapon="weapon" :character-skills="characterSkills" />
      </div>
      ...
      <!-- Attack Stats -->
      <div
        v-if="weapon.attack_stats && weapon.attack_stats.length > 0"
        class="border rounded-lg p-4"
      >
      ...
      <!-- Defense Stats -->
      <div
        v-if="weapon.defense_stats && weapon.defense_stats.length > 0"
        class="border rounded-lg p-4"
      >
