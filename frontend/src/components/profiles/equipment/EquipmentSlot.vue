...
<template>
  <div
    ...
    :class="{
      'border-solid border-primary-400 dark:border-primary-500 bg-primary-50 dark:bg-primary-950':
        hasItem,
  ...
  >
    ...
    <div v-if="hasItem" class="flex flex-col items-center justify-center p-1">
      ...
      <!-- Item name (truncated) -->
      <div
        class="text-xs text-center text-surface-700 dark:text-surface-300 leading-tight max-w-full"
      >
    ...
    <div
      v-else
      class="flex flex-col items-center justify-center text-surface-400 dark:text-surface-500"
    >
    ...
    <div v-if="hasItem && itemQL" class="absolute -top-1 -right-1">
      <div
        class="bg-primary-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold"
      >
        {{ itemQL }}
      </div>
    </div>
