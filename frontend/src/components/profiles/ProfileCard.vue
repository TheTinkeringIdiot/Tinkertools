...
-->
<template>
  <div class="profile-card bg-surface-0 dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg hover:shadow-lg transition-all duration-200 overflow-hidden">
    ...
    <div class="px-4 pb-4">
      ...
      <div class="bg-surface-50 dark:bg-surface-800 rounded-lg p-3 mb-4">
        <div class="flex items-center justify-between mb-2">
          <span class="text-xs font-medium text-surface-700 dark:text-surface-300 uppercase tracking-wider">
            Character Stats
          </span>
          <Button
            icon="pi pi-eye"
