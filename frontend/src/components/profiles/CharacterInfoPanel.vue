...
<template>
  <div
    class="character-info-panel bg-surface-0 dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg p-6"
  >
    ...
    <div class="mb-4 p-3 bg-surface-50 dark:bg-surface-800 rounded-lg">
      ...
      <div class="text-lg font-bold text-surface-900 dark:text-surface-50">
        {{ profile.Character?.Name || 'Unknown' }}
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-4 mb-6">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div
          class="p-3 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800"
        >
          <div class="flex items-center gap-2 mb-1">
      ...
      <div class="space-y-3">
        ...
        >
          ...
          <span class="text-sm text-surface-900 dark:text-surface-50">{{
            getProfessionName(profile.Character?.Profession || 0)
          }}</span>
        </div>
        ...
        >
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm text-surface-900 dark:text-surface-50">{{
              getBreedName(profile.Character?.Breed || 0)
            }}</span>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="text-sm text-surface-900 dark:text-surface-50">{{
              profile.Character?.Faction || 'Unknown'
            }}</span>
          </div>
        </div>
        ...
        >
          ...
          <span class="text-sm text-surface-900 dark:text-surface-50">{{
            profile.Character?.Expansion || 'Unknown'
          }}</span>
        </div>
        ...
        <div class="flex items-center justify-between py-2">
          <span class="text-sm font-medium text-surface-700 dark:text-surface-300"
            >Account Type</span
          >
          <Badge :value="profile.Character?.AccountType || 'Froob'" severity="secondary" />
        </div>
      </div>
    </div>
      ...
      <div class="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div class="flex items-center gap-2">
            ...
            <span
              v-if="attribute.skill.trickleDown"
