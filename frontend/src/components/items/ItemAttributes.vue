        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <Tag :value="tradeableStatus" :severity="getTradeableSeverity()" />
            </div>
            ...
            >
              ...
              <Tag :value="droppableStatus" :severity="getDroppableSeverity()" />
            </div>
          </div>
        </div>
