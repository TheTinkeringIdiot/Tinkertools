...
<template>
  <div v-if="slotInfo.type" :class="['slots-display', slotInfo.type]">
    ...
    >
      ...
      <i v-else-if="cell.isValid && !slotInfo.iconUrl" class="pi pi-box slot-fallback-icon"></i>
  ...
  <div v-else class="text-center space-y-4">
    <!-- Item Image -->
    <div
      class="h-32 bg-surface-100 dark:bg-surface-800 rounded-lg flex items-center justify-center"
    >
      <img
