  ...
  <Card v-if="hasSources">
    <template #content>
      <div class="item-sources-component">
          ...
          >
            <div class="flex items-start gap-3">
              ...
              <div class="flex-shrink-0">
                ...
                >
                  <i :class="getSourceIcon(source.source.source_type?.name)" class="text-sm text-surface-500"></i>
                </div>
              </div>
              ...
              <div class="flex-1 min-w-0">
                ...
                <!-- Additional Info -->
                <div v-if="hasAdditionalInfo(source)" class="flex flex-wrap gap-3 text-xs text-surface-600 dark:text-surface-400">
        ...
        <div v-if="sources.length === 0" class="text-center py-4 text-surface-500 dark:text-surface-400 text-sm italic">
