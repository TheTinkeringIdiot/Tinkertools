  ...
  <div class="nano-filters p-4 space-y-4">
    ...
    <div class="space-y-2">
      ...
      <div class="space-y-2 max-h-40 overflow-y-auto">
        ...
        >
          <Checkbox
            v-model="selectedStrains"
            :inputId="`strain-${strain}`"
            :value="strain"
          />
          <label 
            :for="`strain-${strain}`"
    ...
    <div v-if="showCompatibility && activeProfile" class="space-y-4 pt-4 border-t border-surface-200 dark:border-surface-700">
      ...
      <div class="space-y-2">
        <div class="flex items-center gap-2">
          <Checkbox
            v-model="filters.skillCompatible"
            inputId="skill-compatible"
            binary
          />
          <label 
        ...
        <div class="flex items-center gap-2">
          <Checkbox
            v-model="filters.castable"
            inputId="fully-castable"
            binary
          />
          <label 
            for="fully-castable"
...
const targetTypes = [
  'Self', 'Team Member', 'Enemy', 'Area', 'Item', 'Pet'
];
...
const hasActiveFilters = computed(() => {
  return selectedQualityLevels.value.length > 0 ||
