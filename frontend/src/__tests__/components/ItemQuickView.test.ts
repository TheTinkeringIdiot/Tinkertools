...
const mockItem: Item = {
  ...
  ql: 220,
  description:
    'A state-of-the-art military-grade weapon with enhanced targeting systems and superior damage output.',
  ...
  actions: [{ name: 'aimed_shot', description: 'Take careful aim for increased damage' }],
  attack_defense: {
    attack_min: 120,
    attack_max: 240,
    attack_speed: 1.8,
...
const mockNanoItem: Item = {
  ...
  spell_data: [{ name: 'Rapid Healing', description: 'Restores health over time' }],
  actions: [],
  attack_defense: null,
  animation_mesh: null,
};
  ...
  describe('Responsive Design', () => {
    ...
    it('should handle long item names and descriptions gracefully', () => {
      const longNameItem = {
        ...
        description:
          'A very long description that goes on and on with lots of details about the item and its many features and capabilities that should wrap properly and not overflow the container boundaries.',
      };
