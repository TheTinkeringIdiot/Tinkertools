...
describe('action-criteria service', () => {
  ...
  describe('parseCriteriaExpression', () => {
    it('should handle simple stat requirements', () => {
      const criteria: Criterion[] = [{ id: 1, value1: 112, value2: 356, operator: 2 }];
    ...
    it('should handle complex nested expressions', () => {
      ...
      expect(result?.description).toBe(
        '((Profession = Bureaucrat AND Pistol ≥ 443) AND FlingShot ≥ 222)'
      );
    });
  ...
  describe('parseAction', () => {
    it('should parse a complete action with criteria', () => {
      const action: Action = {
        ...
        action: 6, // Wield
        item_id: 123,
        criteria: [{ id: 1, value1: 112, value2: 356, operator: 2 }],
      };
  ...
  describe('checkActionRequirements', () => {
    const mockAction = {
      ...
      rawCriteria: [{ id: 1, value1: 112, value2: 356, operator: 2 }],
    };
    ...
    it('should handle different operators correctly', () => {
      const equalAction = {
        ...
        rawCriteria: [{ id: 1, value1: 112, value2: 8, operator: 0 }],
      };
...
describe('integration tests', () => {
  it('should handle real-world Dark Pistol example correctly', () => {
    ...
    expect(result.hasRequirements).toBe(true);
    expect(result.expression?.description).toBe(
      '((Profession = Bureaucrat AND Pistol ≥ 443) AND FlingShot ≥ 222)'
    );
