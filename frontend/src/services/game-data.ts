...
export const INTERP_STATS = [
  ...
  156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 168, 201, 204, 205, 206, 207, 208,
  214, 216, 217, 218, 219, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 238, 239, 240, 241,
...
export const SPELL_FORMATS = {
  ...
  53073:
    'Hit all {Stat} within {Radius}m for {MinAmount} to {MaxAmount}, modified by {ModifierStat}',
...
export const SKILL_COST_FACTORS: Record<number, Record<number, number>> = {
  ...
  145: {
    // Parry (mapped from Deflect in VB)
    6: 1.5,
    5: 1.6,
    8: 3.2,
    10: 2.4,
  ...
  101: {
    // Multi Melee (mapped from Mult. Melee)
    6: 1.4,
    5: 2.5,
    8: 4.0,
    10: 3.2,
