...
export const IMP_SKILLS = {
  'Eye': {
    'Shiny': ['Aimed Shot','Elec. Engi','Map Navig','RangeInc. Weapon','Rifle','Tutoring','Vehicle Air'],
    'Bright': ['Chemistry','Comp. Liter','Grenade','Heavy Weapons','Intelligence','Mech. Engi','Mult. Melee','Nano Progra','NanoC. Init','Perception','Pharma Tech','Psycho Modi','Quantum FT','Ranged Ener','Sensory Impr','Treatment','Vehicle Grnd','Vehicle Hydr'],
    'Faded': ['Assault Rif','Bow','Concealment','Matter Crea','Multi Ranged','Pistol','Psychology','Sharp Obj','Sneak Atck','Time & Space','Weapon Smt']
  },
  'Head': {
    'Shiny': ['Bio.Metamor','Bow Spc Att','Chemistry','Comp. Liter','Disease AC','First Aid','Intelligence','Matt.Metam','Matter Crea','Max Nano','Mech. Engi','Melee Ener','Nano Progra','Nano Resist','NanoC. Init','Pharma Tech','Psychic','Psycho Modi','Psychology','Quantum FT','Ranged Ener','Sensory Impr','Time & Space','Treatment','Vehicle Grnd','Vehicle Hydr'],
    'Bright': ['Dimach','Elec. Engi','Map Navig','Nano Pool','Ranged. Init','Weapon Smt'],
    'Faded': ['Perception','Sense','Trap Disarm','Tutoring','Vehicle Air']
  },
  'Ear': {
    'Shiny': ['Add. Xp','Max NCU','Perception'],
    'Bright': ['Concealment','Nano Point Cost Modifier','Psychology','Tutoring','Vehicle Air'],
    'Faded': ['Intelligence','Map Navig','Psychic','Psycho Modi','Vehicle Grnd','Vehicle Hydr']
  },
  'Right-Arm': {
    'Shiny': ['1h Blunt','1h Edged Weapon','2h Blunt','2h Edged','Assault Rif','Bow','Break & Entry','Burst','Fling Shot','Full Auto','Grenade','Heavy Weapons','MG / SMG','Piercing','Shotgun','Strength'],
    'Bright': ['Add All Def.','Add All Off','Brawling','Chemical AC','Nano Delta','Physic. Init','Swimming'],
    'Faded': ['Fast Attack','Mech. Engi','Parry','Radiation AC','RangeInc. NF','RangeInc. Weapon','Riposte']
  },
  'Chest': {
    'Shiny': ['Body Dev','Dimach','Energy AC','Max Health','Melee/Ma AC','Nano Pool','Sense','Stamina'],
    'Bright': ['Bio.Metamor','Imp/Proj AC','Matt.Metam','Psychic'],
    'Faded': ['2h Blunt','Adventuring','Break & Entry','Disease AC','MG / SMG','Max Nano','Nano Formula Interrupt Modifier','NanoC. Init','Sensory Impr','Skill Time Lock Modifier','Strength']
  },
  'Left-Arm': {
    'Shiny': ['Add All Def.','Add All Off','Brawling','Heal Delta','RangeInc. NF'],
    'Bright': ['2h Blunt','2h Edged','Bow','Break & Entry','Piercing','Radiation AC','Strength'],
    'Faded': ['Chemical AC','Matt.Metam','Nano Point Cost Modifier','Physic. Init','Swimming']
  },
  'Right-Wrist': {
    'Shiny': ['Nano Delta','Parry','Pistol','Ranged. Init','Riposte','Run Speed','Sharp Obj'],
    'Bright': ['1h Blunt','1h Edged Weapon','Aimed Shot','Burst','Full Auto','Max NCU','Multi Ranged','Nano Resist','Rifle','Sneak Atck'],
    'Faded': ['Add. Chem. Dam.','Add. Energy Dam.','Add. Fire Dam.','Add. Melee Dam.','Add. Poison Dam.','Add. Proj. Dam.','Add.Rad. Dam.','Bow Spc Att','Fling Shot','Melee Ener','Mult. Melee']
  },
  'Waist': {
    'Shiny': ['Chemical AC','Cold AC','Fire AC','Nano Point Cost Modifier','Radiation AC'],
    'Bright': ['Adventuring','Body Dev','Duck-Exp','Max Health','Max Nano','Melee/Ma AC','Sense'],
    'Faded': ['2h Edged','Agility','Bio.Metamor','Brawling','Dimach','Dodge-Rng','Energy AC','Evade-ClsC','Full Auto','Imp/Proj AC','Melee. Init','Nano Pool','Piercing','Shotgun','Stamina']
  },
  'Left-Wrist': {
    'Shiny': ['Mult. Melee','Multi Ranged','Shield Energy AC','Shield Fire AC','Shield Projectile AC','Shield Radiation AC'],
    'Bright': ['Add. Chem. Dam.','Add. Energy Dam.','Add. Fire Dam.','Add. Melee Dam.','Add. Poison Dam.','Add. Proj. Dam.','Add.Rad. Dam.','Melee Ener','Parry','Riposte','Run Speed'],
    'Faded': ['Nano Resist','Rifle','Shield Chemical AC','Shield Cold AC','Shield Melee AC','Shield Poison AC']
  },
  'Right-Hand': {
    'Shiny': ['Add. Chem. Dam.','Add. Energy Dam.','Add. Fire Dam.','Add. Melee Dam.','Add. Poison Dam.','Add. Proj. Dam.','Add.Rad. Dam.','Martial Arts','Trap Disarm','Weapon Smt'],
    'Bright': ['Assault Rif','Bow Spc Att','Cold AC','Fast Attack','First Aid','Fling Shot','MG / SMG','Matter Crea','Pistol','Sharp Obj','Shotgun','Time & Space'],
    'Faded': ['1h Blunt','1h Edged Weapon','Aimed Shot','Burst','Chemistry','Comp. Liter','Elec. Engi','Fire AC','Grenade','Heavy Weapons','Nano Progra','Pharma Tech','Quantum FT','Ranged. Init','Treatment']
  },
  'Leg': {
    'Shiny': ['Adventuring','Agility','Dodge-Rng','Duck-Exp','Imp/Proj AC','Nano Formula Interrupt Modifier','Skill Time Lock Modifier','Swimming'],
    'Bright': ['Disease AC','Energy AC','Evade-ClsC','Melee. Init','Stamina'],
    'Faded': ['Add. Xp','Body Dev','Heal Delta','Max Health','Max NCU','Melee/Ma AC','Run Speed','Shield Energy AC','Shield Fire AC','Shield Projectile AC','Shield Radiation AC']
  },
  'Left-Hand': {
    'Shiny': ['Fast Attack','Shield Chemical AC','Shield Cold AC','Shield Melee AC','Shield Poison AC'],
    'Bright': ['Fire AC','Nano Formula Interrupt Modifier','RangeInc. NF','Shield Energy AC','Shield Fire AC','Shield Projectile AC','Shield Radiation AC','Skill Time Lock Modifier','Trap Disarm'],
    'Faded': ['Cold AC','First Aid','Martial Arts','Ranged Ener']
  },
  'Feet': {
    'Shiny': ['Concealment','Evade-ClsC','Melee. Init','Physic. Init','Sneak Atck'],
    'Bright': ['Add. Xp','Agility','Dodge-Rng','Heal Delta','Martial Arts','RangeInc. Weapon','Shield Chemical AC','Shield Cold AC','Shield Melee AC','Shield Poison AC'],
