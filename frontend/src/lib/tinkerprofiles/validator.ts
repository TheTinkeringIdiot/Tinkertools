...
export class ProfileValidator {
  ...
  private validateCharacter(character: any, errors: string[], warnings: string[], suggestions: string[]): void {
  ...
  private validateSkills(skills: any, errors: string[], warnings: string[], suggestions: string[]): void {
  ...
  private validateNanoSkills(skills: any, errors: string[], warnings: string[], suggestions: string[]): void {
  ...
  private validateStats(stats: any, errors: string[], warnings: string[], suggestions: string[]): void {
  ...
  private validateEquipment(equipment: any, type: string, errors: string[], warnings: string[]): void {
